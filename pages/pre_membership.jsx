...
import UnderTheFold from "../components/UnderTheFold";
...
function PreMembership() {
  ...
  return (
    <div className="divide-y-2 divide-line/75 ">
      ...
      <Navbar />
      <TopBannerCarousel title={"Process Tagline"} />
      <UnderTheFold
        title={"OUR PRODUCTS"}
        description={
      ...
      />
      <Map />
      <TopBannerCarousel title={"Active filter for models"} />
      <AboutProperties />
      <Testimonial />
      <Footer />
    </div>
